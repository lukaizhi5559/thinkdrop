  ...
  ipcRenderer: {
    send: (channel, data) => {
      const validChannels = [
        ...
        'agents:train-preview-run',
        'agents:train-clear-events',
        'agents:list-trained-skills',
        'agents:train-review-save',
        'agents:train-review-cancel',
        'agents:guided-train-done',
        'agents:guided-train-skip',
        'agents:guided-train-cancel',
        'agents:guided-train-finish',
    ...
    on: (channel, func, token) => {
      const validChannels = [
        ...
        'agents:train-preview-run-result',
